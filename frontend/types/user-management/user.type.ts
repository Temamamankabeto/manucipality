...
export type UserItem = { id: number; name: string; email: string; phone?: string | null; address?: string | null; status?: UserStatus; role?: UserRoleName | string | null; roles?: Array<RoleItem | string>; admin_level?: AdminLevel | null; office_id?: number | null; sub_city_id?: number | null; woreda_id?: number | null; zone_id?: number | null; office?: OfficeItem | null; sub_city?: OfficeItem | null; woreda?: OfficeItem | null; zone?: OfficeItem | null; profile_image_url?: string | null; last_login_at?: string | null; created_at?: string; updated_at?: string };
...
export type CreateUserPayload = { name: string; email: string; phone: string; password: string; role: UserRoleName | string; admin_level?: AdminLevel | null; address?: string; office_id?: number | null; sub_city_id?: number | null; woreda_id?: number | null; zone_id?: number | null };
